...
# --- Test Configuration ---
# We will test only the Groq model this time.
# The model name is prefixed with "groq/" as per litellm convention.
MODEL_TO_TEST = "groq/llama3-8b-8192"
TEST_PLAYER_ID = 0

async def test_groq_agent():
    """
    A self-contained function to test the Groq agent.
    """
