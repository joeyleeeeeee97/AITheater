...
# --- Test Configuration ---
# Re-testing the DeepSeek Reasoner model.
MODEL_TO_TEST = "deepseek/deepseek-reasoner"
TEST_PLAYER_ID = 0

async def test_deepseek_reasoner_agent():
    """
    A self-contained function to re-test the DeepSeek Reasoner agent.
    """
    print(f"--- Focused Re-Test for: {MODEL_TO_TEST} ---")
...
if __name__ == "__main__":
    asyncio.run(test_deepseek_reasoner_agent())
